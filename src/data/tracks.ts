...
/** Public `public/audio/` filename → URL-safe path for non-ASCII names. */
function audioPublicPath(filename: string): string {
...
export const demoTracks: Track[] = [
  {
    ...
    previewUrl: audioPublicPath("Валя.wav"),
  ...
  },
  {
    ...
    previewUrl: audioPublicPath("Дневник.wav"),
  ...
  },
  {
    ...
    previewUrl: audioPublicPath("Как я.wav"),
